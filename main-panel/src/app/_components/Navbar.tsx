      ...
      <div className="p-6">
        <Link href="/" className="flex items-center gap-2.5 focus:outline-none focus:ring-2 focus:ring-[#10B981] rounded-lg">
          ...
          <div className="text-left">
            <span className="font-bold text-lg text-gray-900 block leading-none">Podium</span>
            <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Console</span>
          </div>
        </Link>
      </div>
